...
const Nav: React.FC = () => {
  return (
    <nav className='hidden lg:block' aria-label='In-page jump links'>
      <ul className='mt-16 w-max border-l border-gray-600 px-4'>
          ...
          (item) => (
            <li key={item}>
              ...
              >
                ...
                <div className='nav-indicator absolute -left-px h-6 w-[2px] bg-sky-400 opacity-0 group-hover:opacity-100 group-focus:opacity-100'></div>
